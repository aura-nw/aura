...
import (
	...
	"github.com/aura-nw/aura/hasura/handlers"
	actionstypes "github.com/aura-nw/aura/hasura/types"
)
...
func (m *HasuraService) Start() error {
	// Build the worker
...
func (m *HasuraService) trapSignal() {

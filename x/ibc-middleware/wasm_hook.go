// Source: https://github.com/osmosis-labs/osmosis/blob/5abdbb9bbff0f7b421b1cc5a3ee67ac87f78d3dd/x/ibc-hooks/wasm_hook.go
...
import (
	...
	"github.com/aura-nw/aura/x/ibc-middleware/keeper"
...
func NewWasmHooks(ibcMiddlewareKeeper *keeper.Keeper, contractKeeper *wasmkeeper.PermissionedKeeper, bech32PrefixAccAddr string) WasmHooks {
	return WasmHooks{
		ContractKeeper:      contractKeeper,
		ibcMiddlewareKeeper: ibcMiddlewareKeeper,
		bech32PrefixAccAddr: bech32PrefixAccAddr,
	}
}

func (h WasmHooks) ProperlyConfigured() bool {
	return h.ContractKeeper != nil && h.ibcMiddlewareKeeper != nil
}
...
func (h WasmHooks) SendPacketOverride(i ICS4Middleware, ctx sdk.Context, chanCap *capabilitytypes.Capability, packet ibcexported.PacketI) error {
	...
	h.ibcMiddlewareKeeper.StorePacketCallback(ctx, packet.GetSourceChannel(), packet.GetSequence(), contract)
	return nil
}
...
func (h WasmHooks) OnAcknowledgementPacketOverride(im IBCMiddleware, ctx sdk.Context, packet channeltypes.Packet, acknowledgement []byte, relayer sdk.AccAddress) error {
	...
	contract := h.ibcMiddlewareKeeper.GetPacketCallback(ctx, packet.GetSourceChannel(), packet.GetSequence())
	if contract == "" {
	...
	h.ibcMiddlewareKeeper.DeletePacketCallback(ctx, packet.GetSourceChannel(), packet.GetSequence())
	return nil
}

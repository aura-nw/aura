...
// provisions values.
func NewMinter(inflation, epochProvisions sdk.Dec) Minter {
	return Minter{
		Inflation:       inflation,
...
func (m Minter) NextInflationRate(params Params, bondedRatio sdk.Dec) sdk.Dec {
	...
	inflationRateChange := inflationRateChangePerYear.Quo(sdk.NewDec(int64(params.EpochsPerYear)))
...
func (m Minter) EpochReward(params Params) sdk.Coin {
	return sdk.NewCoin(params.MintDenom, m.EpochProvisions.TruncateInt())
}

...
func NewIBCMiddleware(app porttypes.IBCModule, ics4Middleware *ICS4Middleware) IBCMiddleware {
...
func (im IBCMiddleware) OnRecvPacket(
	...
	return im.Ics4Middleware.wasm.OnRecvPacketOverride(im, ctx, packet, relayer)
}
...
func (im IBCMiddleware) OnAcknowledgementPacket(
	...
	return im.Ics4Middleware.wasm.OnAcknowledgementPacketOverride(im, ctx, packet, acknowledgement, relayer)
}
...
func (im IBCMiddleware) OnTimeoutPacket(
	...
	return im.Ics4Middleware.wasm.OnTimeoutPacketOverride(im, ctx, packet, relayer)
}

...
func TestActivateAccountValidateBasic(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		},
		{
			...
			msg: &types.MsgActivateAccount{
				AccountAddress: "aura17n858c4urvenkf7edjs4uumudej3ekyv432e34",
...
func TestRecoverValidateBasic(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		},
		{
			desc: "error, account address invalid bench32 string",
			msg: &types.MsgRecover{
				Creator: "aura17n858c4urvenkf7edjs4uumudej3ekyv432e34",
				Address: "abcde",
			},
			err: true,
		},
		{
			...
			msg: &types.MsgRecover{
				Creator: "aura17n858c4urvenkf7edjs4uumudej3ekyv432e34",
				Address: "aura17n858c4urvenkf7edjs4uumudej3ekyv432e34",
				PubKey: &codectypes.Any{
					TypeUrl: "/cosmos.crypto.secp256k1.PubKey",
					Value:   []byte(nil),
				},
